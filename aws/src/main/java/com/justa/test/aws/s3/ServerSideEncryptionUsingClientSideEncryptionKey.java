...
public class ServerSideEncryptionUsingClientSideEncryptionKey {
	   private static SSECustomerKey SSE_KEY;
	    ...
	    public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
	        ...
	        String keyName = "ServerSideEncryptionUsingClientSideEncryptionKey.txt";
	        String uploadFileName = "installTomcatOnEC2.txt";
	        String targetKeyName = "ServerSideEncryptionUsingClientSideEncryptionKey2.txt";
